...
class CI_Email {
	...
	var	$smtp_host		= "in-v3.mailjet.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "c105dc361458500d7cadea35cecb0653";		// SMTP Username
	var	$smtp_pass		= "724cbcb8c8e9863841862312933881fb";		// SMTP Password
	var	$smtp_port		= "587";		// SMTP Port
	var	$smtp_timeout	= 5;		// SMTP Timeout inseconds
