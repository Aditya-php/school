                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">List Vendor </span>
                       <div style="padding-top:7px" class="pull-right">
					    <a class="btn btn-info btn-sm" href="<?php echo base_url();?>admin/vendor/add"> Add</a>
							   ...
							   <div class="btn-group">
								...
								<a  href="<?php echo base_url();?>admin/vendor/export_vendor">  Export All</a>
								</li>
							...
							<a class="btn btn-info btn-sm" href="#"> Rate This Vendor</a>	
                        </div>
                    </div>
                    <div class="portlet-body">
						...
						<form action="<?php echo base_url().'admin/vendor/export_vendor'; ?>" id="export_form" method="post">
