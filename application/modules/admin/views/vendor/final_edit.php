...
<div class="page-content-wrapper">
        ...
        <ul class="nav nav-tabs" id="createNotTab">
          <li><a href="<?php echo base_url(); ?>admin/vendor/edit/<?php echo ID_encode($result['id']); ?>" data-toggle>Basic Detail</a></li>
          <li class="active"><a href="<?php echo base_url(); ?>admin/vendor/final_edit/<?php echo ID_encode($result['id']); ?>" data-toggle>Full Detail</a></li>
				...
				<div class="form-group">
				 ...
				 <div class="clear"></div>
				  <div class="form-group">
					 <label class="control-label adminlabel col-md-4">  </label>
					 <div class="col-md-8">
						<textarea rows="5" cols="10" type="text" class="detailfields features_text_field" id="" name="facilites_play_station_text" value="" style="<?php if($result['facilites_play_station'] == 1){ echo 'display:inline-block;'; } ?>"><?php echo $result['facilites_play_station_text']; ?></textarea>
					 </div>
				 </div>
				 <div class="clear"></div>
				  <div class="form-group">
				 ...
				 <div class="form-group">
					 <label class="control-label adminlabel col-md-4"> Other: </label>
					 <div class="col-md-8">
						<textarea cols="10" rows="5" class="detailfields" name="facilites_other" value=""><?php echo $result['facilites_other']; ?></textarea>
					 </div>
				 </div>
				 ...
				 <h2 class="addheadding">Co-Curricular Activities   </h2>
				  <div class="form-group">
					 <label class="control-label adminlabel col-md-4"> Features: </label>
					 <div class="col-md-8">
						<textarea cols="10" rows="5" class="detailfields" name="activities_features" value=""><?php echo $result['activities_features']; ?></textarea>
					 </div>
				 </div>
				  ...
				  <div class="form-group">
					 <label class="control-label adminlabel col-md-4"> Features: </label>
					 <div class="col-md-8">
						<textarea cols="10" rows="5" class="detailfields" name="overall_features" value=""><?php echo $result['overall_features']; ?></textarea>
					 </div>
				 </div>
				 ...
				 <div class="clear"></div>
				  <div class="form-group">
					 <label class="control-label adminlabel col-md-4">  </label>
					 <div class="col-md-8">
						<textarea rows="5" cols="10" type="text" class="detailfields features_text_field" id="" name="overall_food_nutrition_text" value="" style="<?php if($result['overall_food_nutrition'] == 1){ echo 'display:inline-block;'; } ?>"><?php echo $result['overall_food_nutrition_text']; ?></textarea>
					 </div>
				 </div>
				 <div class="clear"></div>
				 ...
				 <div class="clear"></div>
				  ...
				  <div class="form-group">
					 <label class="control-label adminlabel col-md-4"> Onsite Screening Facility : </label>
					  <div class="col-md-2 radiobutton-adds">
				 ...
				 <div class="clear"></div>
				  ...
				  <div class="form-group">
					 <label class="control-label adminlabel col-md-4"> Features: </label>
					 <div class="col-md-8">
						<textarea rows="5" cols="10" class="detailfields" name="social_features" value="<?php echo $result['social_features']; ?>"><?php echo $result['social_features']; ?></textarea>
					 </div>
				 </div>
				 ...
				 <div class="clear"></div>
					 <center><a class="addsubmit" href="<?php echo base_url()."admin/vendor/edit/".ID_encode($result['id']); ?>"><span class="glyphicon glyphicon-arrow-left"></span>Previous </a>
					 <button class="addsubmit" type="submit">Submit </button><a href="<?php echo base_url()."admin/vendor/" ?>" class="addsubmit" style="margin-left:5px"> Cancel </a>  </center></center>	
 ...
 /*  $(".addmore-divs").click(function(){
	...
	/* $("#features_id1").click(function(){
	 ...
	 $(".no").click(function(){
		...
		$(this).parent().parent().parent().parent().next().next().find('textarea').attr("value","");
    });
