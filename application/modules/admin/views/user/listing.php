        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">List User </span>
                       <div style="padding-top:7px" class="pull-right">
					   		   <button type="button" class="btn btn-info btn-sm" onclick="delete_multiple('select_all','<?php echo base_url().'admin/user/multi_delete'; ?>')"> Delete  </button>
							   ...
							   <div class="btn-group">
								...
								<a  href="<?php echo base_url();?>admin/user/export_user">   Export All</a>
								</li>
							...
							<a class="btn btn-info btn-sm" href="<?php echo base_url();?>admin/user/add">   Add   </a>	
                        </div>
                    </div>
                    <div class="portlet-body">
						...
						<form action="<?php echo base_url().'admin/user/export_user'; ?>" id="export_form" method="post">
                        <table class="table table-striped table-hover table-bordered" id="role_master">
                            <thead>
                                <tr class="bg-info">
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
        var dataTable = $('#role_master').DataTable({
            "processing": true,
            "serverSide": true,
            ...
            "ordering": false, 
            "ajax": {
                url :<?php base_url(); ?>'user/user_list_ajax/', // json datasource
