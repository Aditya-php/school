        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">List Role </span>
                       <div style="padding-top:7px" class="pull-right">
					   <button type="button" class="btn btn-info btn-sm" onclick="delete_multiple('select_all','<?php echo base_url().'admin/role/multi_delete'; ?>')"> Delete </button>
					       ...
					       <div class="btn-group">
								...
								<a  href="<?php echo base_url();?>admin/role/export_role">  Export All</a>
								</li>
						...
						<a class="btn btn-info btn-sm" href="<?php echo base_url();?>admin/role/add">  Add </a>	
                        </div>
                    </div>
                    <div class="portlet-body">
						...
						<form action="<?php echo base_url().'admin/role/export_role'; ?>" id="export_form" method="post">	
                        <table class="table table-striped table-hover table-bordered" id="roles">
                            <thead>
                                <tr class="bg-info">
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
		var dataTable = $('#roles').DataTable({
            ...
            "ordering": false, 
            "ajax": {
                url :"<?php echo base_url(); ?>admin/role/role_list_ajax",
