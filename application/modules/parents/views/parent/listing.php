...
<?php } ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">List Testimonial </span>
                       <div style="padding-top:7px" class="pull-right">
					    <button type="button" class="btn btn-info btn-sm" onclick="delete_multiple('select_all','<?php echo base_url().'parents/testmonial/multi_delete'; ?>')"> Delete </button>
					     <a class="btn btn-info btn-sm" href="<?php echo base_url();?>parents/testmonial">Add </a>
								...
								<a  href="<?php echo base_url();?>parents/testmonial/export_testmonial"><i class="fa fa-plus" aria-hidden="true"></i> Export All</a>
								</li>
                    ...
                    <div class="portlet-body">
						...
						<form action="<?php echo base_url().'parents/testmonial/export_testmonial'; ?>" id="export_form" method="post">
        ...
        <?php } ?>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                 <a href="javascript:void(0);"  title="Delete"   data-toggle="tooltip" data-placement="top" class="delete" id=""><i class="fa fa-trash"></i></a>
                                                   </td> 
                                            </tr>
                                        <?php
                                    }
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
		var dataTable = $('#users').DataTable({
            ...
            "ordering": false, 
            "ajax": {
                url :<?php base_url(); ?>'testmonial_list_ajax', // json datasource
		...
		$("#deleteDta").click(function(){
		   var conf=confirm('Are you sure you want to delete');
			...
			$('.select_all:checked').each(function(value){
				...
				var ids = $(this).val();
				$.ajax({
					url:"<?php echo base_url('parents/testmonial/multi_delete'); ?>",
					type: "POST",
					data: '&id='+ids,
