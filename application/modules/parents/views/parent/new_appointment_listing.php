        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">My Appointments	</span>
                       <div style="padding-top:7px" class="pull-right">
					  
					   <!--<a class="btn btn-info btn-sm" href="<?php echo base_url();?>vendors/kids/export_kids"> <i class="fa fa-plus" aria-hidden="true"></i> Export </a>-->
                       			   
							<!--<a class="btn btn-info btn-sm" href="<?php echo base_url();?>vendors/invoice/add"> <i class="fa fa-plus" aria-hidden="true"></i> Add  </a>-->
                        </div>
                    </div>
                   ...
                   <form action="<?php echo base_url().'vendors/kids/export_kids'; ?>" id="export_form" method="post">							
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
        var dataTable = $('#area_master').DataTable({
            ...
            "ordering": false, 
            "ajax": {
                url :<?php base_url(); ?>'parents/new_appointment_list_ajax/', // json datasource
...
{
	var flag=confirm('Are you sure want to cancel the appointment?');
	if(flag)
		return true;
	else 
		return false;
