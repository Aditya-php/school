					...
					<span style="float:left;padding-top:10px;color:white;">View Logs</span>
					  ...
					  -->
					     ...
					     <div class="btn-group">
								...
								<a  href="<?php echo base_url().'parents/kids/export_log_kids/'.$kid_id ;?>"><i class="fa fa-plus" aria-hidden="true"></i> Export All</a>
								</li>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
								...
								<form action="<?php echo base_url().'parents/kids/export_log_kids/'.$kid_id ;?>"" id="export_form" method="post">
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
		var dataTable = $('#users').DataTable({
            ...
            "ordering": false, 
            "ajax": {
                url :'<?php echo base_url(); ?>'+'parents/kids/kid_log_list_ajax/'+'<?php echo $kid_id; ?>', // json datasource
