        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">Manage Payments </span>
                       <div style="padding-top:7px" class="pull-right">
								...
								<a  href="<?php echo base_url();?>parents/parents_invoice/export_invoice">  Export All</a>
								</li>
                    ...
                    <div class="portlet-body">
						...
						<form action="<?php echo base_url().'parents/parents_invoice/export_invoice'; ?>" id="export_form" method="post">
...
setTimeout(function()
{ 
$(".bg-info th div ").removeClass('checker');
}, 
500);
</script>           
<script>
...
// function change_paid_status(curr_status)
// {
	// alert(curr_status);
   // var id=[];
    	// $('.select_all:checked').each(function(i){
    ...
    // if(id.length>=1){
         ...
         // if(conf){
        		// $.ajax({
					// url:'<?php echo  base_url().'admin/admin_invoice/change_paid_status' ?>',
					// type: "POST",
					// data: '&id='+id+'&curr_status='+curr_status,
					// success: function(res) {
						// alert(res);return false;
...
// function paid_status(curr_status)
// {
