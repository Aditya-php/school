										...
										<form class='form-horizontal'>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" readonly class="form-control" maxlength="55" id=""  placeholder="dob" value="<?php if(!empty($date)) echo $date; ?>">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" maxlength="3" id="age" onpaste="return false" onKeyPress="return isNumberKey(event)" name="age" placeholder="age" value="<?php if(!empty($val) && !empty($val->kage))echo getAge($val->kage); ?>" readonly="" />
											...
											<div class="form-actions">
												<div class="row">
															<div class="text-center col-md-12">
																<a href="<?php echo base_url().'parents/kids/kid_listing'; ?>" class="btn default" >Back</a>
