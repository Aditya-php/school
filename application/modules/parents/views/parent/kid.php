								...
								<div class="portlet light bordered">
									<div class="portlet-title">
										<div class="caption">
											...
											<span class="caption-subject font-red-sunglo bold uppercase">Add Kid </span>
											
										</div>
									</div>
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<?php echo form_open(base_url().'parents/kids',array('class'=>'form-horizontal')); ?>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" maxlength="55" id="name" name="name" placeholder="Kid name" value="<?php echo set_value('name'); ?>">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" maxlength="55" id="datepicker" onchange="calulate_age(this.value)" name="dob" placeholder="Date of birth" value="<?php echo set_value('dob'); ?>">
                                               ...
                                               <div class="row">
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" maxlength="3" onKeyPress="return isNumberKey(event)" id="age" name="age" placeholder="Age" value="<?php echo set_value('age'); ?>" readonly="" />
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<textarea class="form-control"  id="liking" name="liking" placeholder="Likings" value=""><?php echo set_value('liking');?></textarea>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<textarea class="form-control"  id="disliking" name="disliking" placeholder="Dislikings" value=""><?php echo set_value('disliking'); ?></textarea>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<textarea class="form-control"  id="scared_of" name="scared_of" placeholder="Scared of" value=""><?php echo set_value('scared_of'); ?></textarea>
													...
													<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																<textarea class="form-control"  id="allergic_to" name="allergic_to" placeholder="Allergic to" value=""><?php echo set_value('allergic_to'); ?></textarea>
														...
														<div class="form-group">
															...
															<div class="col-md-8">
															<input type="text" class="form-control"  id="doctor_name" name="doctor_name" placeholder="Doctor Name" value="<?php echo set_value('doctor_name'); ?>">
													...
													<div class="row">
														...
														<div class="form-group">
															...
															<div class="col-md-8">
																  ...
																  <input type="text"  class="form-control"  name="doc_con_num" id="doc_con_num" maxlength="10" onpaste="return false" onKeyPress="return isNumberKey(event)" placeholder="Mobile No." value="<?php echo set_value('doc_con_num'); ?>"/>
