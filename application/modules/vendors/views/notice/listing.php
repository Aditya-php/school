        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">List Notice </span>
                       <div style="padding-top:7px" class="pull-right">
					   	 <button type="button" class="btn btn-info btn-sm" onclick="delete_multiple('select_all','<?php echo base_url().'vendors/notice_title/multi_delete'; ?>')"> Delete </button>
						   ...
						   <div class="btn-group">
								...
								<a  href="<?php echo base_url();?>vendors/notice_title/export_vendor">  Export All</a>
								</li>
							...
							<a class="btn btn-info btn-sm" href="<?php echo base_url();?>vendors/notice_title/add">  Add  </a>	
                        </div>
                    </div>
                    <div class="portlet-body">
						...
						<form action="<?php echo base_url().'vendors/notice_title/export_vendor'; ?>" id="export_form" method="post">
