...
<div class="page-content-wrapper">
	...
	<div class="portlet light bordered">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
											<?php echo form_open(base_url().'vendors/invoice/edit/'.ID_encode($value->id),array('class'=>'form-horizontal','enctype'=>'multipart/form-data','id'=>'invoice_form')); ?>
                                              ...
                                              <div class="col-md-6">
													...
													<?php if(isset($data1) && !empty($data1)){ ?>
														...
														<?php
															...
															{ 
															?>
                                                        <option value="<?php echo $val->id."_".$val->parent_id;?>"<?php echo  set_select('kid_detail',  $val->id."_".$val->parent_id, ((!empty($value->kid_detail) && (  $val->id."_".$val->parent_id == $value->kid_detail) ) ? TRUE : FALSE ));?>><?php echo ucwords($val->kid_name)."(".$val->id.")--".ucwords($val->parent_name)."(".$val->parent_id.")"; ?></option>
														<?php 
															}
															?>
											...
											{
											?>
											<img class="uploadimgs-show" src="<?php echo base_url().'assets/upload_image/'.$res[0]->image;?>" height="50px"; width="50px" style="float:right";>
											<?php
											}
											else{
											}
												...
												<div class="row">
                                               	<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" onpaste="return false" onKeyPress="return isNumberKey(event)" id="amount" name="amount" placeholder="Amount" value="<?php echo set_value('amount',$value->amount); ?>">
																<?php echo form_error('amount');?>
																 
															</div>
														</div>
													</div>
													<?php $date = $value->invoice_date; //pr($date);
													$date1 =  date("d-M-Y",strtotime($date));//pr($date1);die;?>
											<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-4">Invoice Date<span class="star">*</span> :</label>
															<div class="col-md-8">
																<input type="text" class="form-control" maxlength="55" id="datepicker" name="invoice_date" placeholder="Invoice Date" value="<?php echo set_value('invoice_date',$date1); ?>">
											...
											<?php $date = $value->due_date; //pr($date);
													$date1 =  date("d-M-Y",strtotime($date));//pr($date1);die;?>
											<div class="row">
												<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
																<input type="text" class="form-control" maxlength="55" id="datepicker1" name="due_date" placeholder="Due Date" value="<?php echo set_value('due_date',$date1); ?>">
