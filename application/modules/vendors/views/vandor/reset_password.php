...
<?php } ?>
        ...
        <!--Breadcrumb End-->
								<div class="portlet light bordered">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<?php echo form_open(base_url().'vendors/account/reset_password',array('class'=>'form-horizontal','id'=>'res_if')); ?>
												...
												<div class="row">
														...
														<div class="row">
															...
															<div id="loader_signup"> </div>	
																<button type="button"  class="btn green res_pass" id="signUp_btn"><i aria-hidden="true" class="fa fa-check"></i>    Submit</button>
 ...
 <script type="text/javascript">
	...
	$(".res_pass").click(function()
   {
	    ...
	    $.ajax({
			url:site_url+"vendors/account/resetpassword",
			type:'post',
			data:value,
			 beforeSend : function(){
