        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">LIST Area </span>
                       <div style="padding-top:7px" class="pull-right">
					   		   <button type="button" class="btn btn-info btn-sm" id="deleteDta"> Delete Area</button>
					   <a class="btn btn-info btn-sm" href="<?php echo base_url();?>admin/area/export_area">   Export Area</a>
							<a class="btn btn-info btn-sm" href="<?php echo base_url();?>admin/area/add">   Add Area </a>	
                        </div>
                    </div>
