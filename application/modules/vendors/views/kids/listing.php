        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
					...
					<span style="float:left;padding-top:10px;color:white;">Kids Listing</span>
					   ...
					   <!--<a class="btn btn-info btn-sm" href="<?php echo base_url();?>vendors/kids/export_kids"> <i class="fa fa-plus" aria-hidden="true"></i> Export </a>-->
                            <div class="btn-group">
								...
								<a  href="<?php echo base_url();?>vendors/kids/export_kids">  Export All</a>
								</li>
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function () {
        var dataTable = $('#area_master').DataTable({
            ...
            "ordering": false, 
            "ajax": {
                url :<?php base_url(); ?>'kids_list_ajax/', // json datasource
